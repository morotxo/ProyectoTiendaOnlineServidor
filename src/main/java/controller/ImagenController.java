...
public class ImagenController implements Serializable {
    ...
    @EJB
    private facade.ImagenFacade ejbFacade;
...
//                    pr=new Producto(2);
//                    return new ListDataModel(getFacade().findbyEstado(pr));
                }
            };
        }
        return pagination;
    ...
    public String prepareView() {
        current = (Imagen) getItems().getRowData();
    ...
    public void setCurrent(Imagen c){
        current=c;
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ImagenDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
